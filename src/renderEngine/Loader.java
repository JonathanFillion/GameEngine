...
public class Loader {
	...
	/*
	 * attributeNumver: VAO index
	 * coordinateSize: Type of points sent (2D, 3D, 4D)
	 * data: data
	 * */
	private void storeDataInAttributesList(int attributeNumber, int coodinateSize, float[] data) {
